...
<div class="data_list">
	...
	<div class="search_content">
		...
		<button style="float: right;margin-bottom: 8px;" class="btn btn-mini btn-primary" type="button" onclick="javascript:window.location='student!preExcel'">导入考生信息</button>
		&nbsp;&nbsp;
