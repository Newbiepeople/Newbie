...
<body>
	<div class="data_list">
		<div class="data_info">
			...
			<p class="examScoreInfo">(&nbsp;满分100&nbsp;&nbsp;单选题30分&nbsp;&nbsp;多选题60分&nbsp;&nbsp;主观题10分&nbsp;)</p>
		</div>
		...
		<div class="data_exam_content">
			<form id="myForm" action="exam!add" method="post">
				<input type="hidden" name="exam.student.id"
					...
					name="exam.paper.id" value="${paper.id }" />
				<c:forEach var="s" items="${tquestionList}" varStatus="status">
					<strong><big>一，主观题</big></strong>(每题10分，答错不得分)<br />
					<br />
					<strong>[&nbsp;${status.index+1 }&nbsp;]&nbsp;${s.subject }</strong>
					<br/>
					<textarea id="tarea" name="subject-answer" rows="8" cols="30"></textarea>
					<br />

				</c:forEach>


				<strong><big>二，单选题</big></strong>(每题1分，答错不得分)<br />
				<br />
				...
				<br /> <strong><big>三，多选题</big></strong>(每题2分，答错不得分)<br />
				<br />
