...
public class MD5 {
	 ...
	 */
	protected static String digestHexStr;
	...
	public static void main(String args[]) {
		...
		System.out.println("MD5 Test suite:"+MD5.getMD5ofStr(password));
		System.out.println("MD5 Test suite:"+MD5.getMD5ofStr(MD5.getMD5ofStr(password)));		
	}
